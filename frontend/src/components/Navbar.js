                ...
                <div className="hidden  md:block md:ml-10 md:pr-4 md:space-x-8">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="text-lg space-x-6 font-pop hover:border-b-stone-800 hover:border-b-2 transition-all ease-in text-gray-500 hover:text-gray-900"
                    >
                      {item.name}
                    </a>
                  ))}
                </div>
                <div className="lg:absolute d-none lg:right-0">
                  <a
